const CHAT_MODEL = process.env.GEMINI_MODEL || 'gemini-3.1-flash';
const TTS_MODEL = process.env.GEMINI_TTS_MODEL || 'gemini-3.1-flash-tts';
const VOICE_NAME = process.env.GEMINI_VOICE || 'Leda';
...
module.exports = async function handler(req, res) {
  ...
  if (body.mode === 'tts') {
    ...
    const ttsUrl = `https://generativelanguage.googleapis.com/v1beta/models/${encodeURIComponent(TTS_MODEL)}:generateContent`;
  ...
  const url = `https://generativelanguage.googleapis.com/v1beta/models/${encodeURIComponent(CHAT_MODEL)}:generateContent`;
